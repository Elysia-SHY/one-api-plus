...
func InitOptionMap() {
	...
	// ---- One API Plus ----
	config.OptionMap["ModelSyncEnabled"] = strconv.FormatBool(config.ModelSyncEnabled)
	config.OptionMap["ModelSyncInterval"] = strconv.Itoa(config.ModelSyncInterval)
	config.OptionMap["ModelSyncAutoEnable"] = strconv.FormatBool(config.ModelSyncAutoEnable)
	config.OptionMap["HealthCheckEnabled"] = strconv.FormatBool(config.HealthCheckEnabled)
	config.OptionMap["HealthCheckInterval"] = strconv.Itoa(config.HealthCheckInterval)
	config.OptionMap["HealthCheckAutoPause"] = strconv.FormatBool(config.HealthCheckAutoPause)
	config.OptionMap["RoutingStrategy"] = config.RoutingStrategy
	config.OptionMap["FallbackEnabled"] = strconv.FormatBool(config.FallbackEnabled)
	config.OptionMap["FallbackModels"] = config.FallbackModelsRaw
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "Theme":
		config.Theme = value
	// ---- One API Plus ----
	case "ModelSyncEnabled":
		config.ModelSyncEnabled = value == "true"
	case "ModelSyncInterval":
		config.ModelSyncInterval, _ = strconv.Atoi(value)
	case "ModelSyncAutoEnable":
		config.ModelSyncAutoEnable = value == "true"
	case "HealthCheckEnabled":
		config.HealthCheckEnabled = value == "true"
	case "HealthCheckInterval":
		config.HealthCheckInterval, _ = strconv.Atoi(value)
	case "HealthCheckAutoPause":
		config.HealthCheckAutoPause = value == "true"
	case "RoutingStrategy":
		config.RoutingStrategy = value
	case "FallbackEnabled":
		config.FallbackEnabled = value == "true"
	case "FallbackModels":
		config.FallbackModelsRaw = value
		err = config.SetFallbackModels(value)
	case "AliasEnabled":
		config.AliasEnabled = value == "true"
	case "BudgetEnabled":
