...
import (
	...
	"github.com/Elysia-SHY/one-api-plus/common/message"
...
func TestChannel(c *gin.Context) {
	...
	go health.RecordResult(channel.Id, channel.Name, err == nil, int(milliseconds), errMsg)
	...
	go func() {
		for _, channel := range channels {
			...
			if err != nil {
				...
				testErrMsg = openaiErr.Message
			}
			health.RecordResult(channel.Id, channel.Name, err == nil && openaiErr == nil, int(milliseconds), testErrMsg)
