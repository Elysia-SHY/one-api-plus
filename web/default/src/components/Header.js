...
let headerButtons = [
  ...
  {
    name: 'header.plus.catalog',
    to: '/plus/catalog',
    icon: 'database',
    admin: true,
  },
  {
    name: 'header.plus.capability',
    to: '/plus/capability',
    icon: 'microchip',
    admin: true,
  },
  {
    name: 'header.plus.group',
    to: '/plus/group',
    icon: 'object group',
    admin: true,
  },
  {
    name: 'header.plus.ratelimt',
    to: '/plus/ratelimit',
    icon: 'tachometer alternate',
    admin: true,
  },
  {
    name: 'header.plus.mcp',
    to: '/plus/mcp',
    icon: 'plug',
    admin: true,
  },
  {
    name: 'header.plus.memory',
    to: '/plus/memory',
    icon: 'memory',
  },
  {
    name: 'header.plus.responses',
    to: '/plus/responses',
    icon: 'commenting',
    admin: true,
  },
  {
    name: 'header.plus.dashboard',
    to: '/plus/dashboard',
    icon: 'dashboard',
    admin: true,
  },
  {
    name: 'header.plus.config',
    to: '/plus/config',
    icon: 'cogs',
    admin: true,
  },
