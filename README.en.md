...
<p align="center">
  ...
  ·
  <a href="https://github.com/Elysia-SHY/one-api-plus/issues">Feedback</a>
  ·
...
### Manual Deployment
1. Download the executable file from [GitHub Releases](https://github.com/Elysia-SHY/one-api-plus/releases/latest) or compile from source:
   ```shell
...
Refer to [#175](https://github.com/Elysia-SHY/one-api-plus/issues/175) for detailed instructions.

If you encounter a blank page after deployment, refer to [#97](https://github.com/Elysia-SHY/one-api-plus/issues/97) for possible solutions.
